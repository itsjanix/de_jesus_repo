...
All of the data were changed by declaring the data frame's object and using brackets[]. Obtaining the rank number via the vector name, where the values need to be. Finally, to access the modified data, declare the object name again. JK Rowling's rank was reduced from 19 to 15, and her annual salary increased from 75 to 90.